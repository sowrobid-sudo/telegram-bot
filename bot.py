...
def tiktok_menu():
    ...
    like_btn = InlineKeyboardButton("❤️ Like", url="https://your-like-link.com")
...
def callback(call):
    if call.data == "tiktok_menu":
        bot.edit_message_text("Choose TikTok Service:", call.message.chat.id, call.message.message_id,
                              reply_markup=tiktok_menu())

    elif call.data == "back_main":
        bot.edit_message_text("Welcome! Choose a service:", call.message.chat.id, call.message.message_id,
